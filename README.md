...
1.	Select an Instrument: Choose from the instrument menu (currently optimized for Grand Piano).  
2.	Play: Use your keyboard to trigger notes:  
o	Left Hand (Q to B): Low-range octaves.  
o	Right Hand (Y to /): High-range octaves.  
